...
object TextNormalizer {
    ...
    private val correctionMap = mapOf(
        listOf("N1K", "NIK1", "N1KI", "IK") to "NIK",
        ...
        listOf(
            ...
            "TEMPATFGL", "TEMPATTGF", "EMPAT / TGL", "EMPAT/TGL", "TEMPATLGL", "EMPAT GL", "TEMPATTGL", "NPAT / TGI"
        ) to "Tempat/Tgl",
        listOf(
            "JK",
            "JNS KLAMIN",
        ...
        listOf(
            ...
            "KEWARNEGARAAN", "KWARGAN", "WARGANEGARAAN", "EWARGANEGARAAN", "KEW ARGANEGARAAN", "VARGANEGARAAN"
        ) to "Kewarganegaraan",
        ...
        listOf(
            ...
            "BERLAKUFNGGA", "TAKU HINGGA", "BERAIU HINGGA", "ERLAKU HINGGA", "AKU HINGGA"
        ) to "Berlaku Hingga",
